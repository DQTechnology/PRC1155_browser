...
public class Token721Service {
    ...
    public RespPage<QueryTokenIdListResp> queryTokenIdList(QueryTokenIdListReq req) {
        ...
        Page<Token721Inventory> tokenInventorys = token721InventoryMapper.selectByExample(example);
    ...
    public QueryTokenIdDetailResp queryTokenIdDetail(QueryTokenIdDetailReq req) {
        ...
        CustomToken721Inventory customToken721Inventory = customToken721InventoryMapper.selectTokenInventory(tokenInventoryKey);
        return QueryTokenIdDetailResp.copy(customToken721Inventory);
    }
