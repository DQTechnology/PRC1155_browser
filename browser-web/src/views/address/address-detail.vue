<template>
  <div class="contract-detail-wrap">
      ...
      <el-row class="overview-wrap" type="flex" justify="space-between">
        <el-col :span="11">
          ...
          <div class="overview">
            ...
            <ul>
                ...
                <div>
                  ...
                  <div v-if="detailInfo.isRestricting">
                    <span class="restricted">
                      {{ detailInfo.restrictingBalance | formatMoney }}&nbsp;LAT (
                      <a class="blue cursor" @click="goRestricte">{{ $t('contract.restricted') }}</a>
                      )
                    </span>
                  </div>
                </div>
              ...
              <li>
                <!-- PRC20交易 -->
                <label class="Gilroy-Medium">{{ $t('tokens.erc20TokenTxns') }}</label>
                <div class="money">
              ...
              <li>
                <!-- PRC721交易 -->
                <label class="Gilroy-Medium">{{ $t('tokens.erc721TokenTxns') }}</label>
                <div class="money">
              ...
              <li>
                <!-- PRC1155交易 -->
                <label class="Gilroy-Medium">{{ $t('tokens.erc1155TokenTxns') }}</label>
                <div class="money">
        ...
        <el-col :span="11">
          <div class="others overview">
            ...
            <ul>
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.stackingAndDelegations') }}</label>
                <div class="money">
              ...
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.unclaimedReward') }}</label>
                <div class="money">{{ detailInfo.delegateClaim | formatMoney }}&nbsp;LAT</div>
              </li>
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.invalidDelegations') }}</label>
                <div class="money">{{ detailInfo.delegateReleased | formatMoney }}&nbsp;LAT</div>
              </li>
            </ul>
          </div>
        </el-col>
    ...
    <div class="address-trade gray-content content-padding">
      <!-- 地址tab -->
      <div class="tabs">
        <el-button size="medium" :class="{ active: tabIndex == 1 }" @click="tabChange(1)">
          {{ $t('contract.transactions') }}
        </el-button>
        <el-button size="medium" :class="{ active: tabIndex == 2 }" @click="tabChange(2)">
          {{ $t('tokens.erc20Tokens') }}
        </el-button>
        <el-button size="medium" :class="{ active: tabIndex == 3 }" @click="tabChange(3)">
          {{ $t('tokens.erc721Tokens') }}
        </el-button>
      ...
      <!-- Erc721 Token -->
      <erc1155-list v-show="tabIndex == 6" :address="address" :tradeCount="detailInfo"></erc1155-list>
    </div>
  </div>
</template>
<script>
