      ...
      <el-row class="overview-wrap" type="flex" justify="space-between">
        <el-col :span="11">
          ...
          <div class="overview">
            ...
            <ul>
              ...
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.erc20Trade') }}</label>
                <div class="money">
                  {{ detailInfo.erc20TxQty | formatNumber }}
                </div>
              </li>
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.erc721Trade') }}</label>
                <div class="money">
                  {{ detailInfo.erc721TxQty | formatNumber }}
                </div>
              </li>
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.erc1155Trade') }}</label>
                <div class="money">
        ...
        <el-col :span="11">
          <div class="others overview">
            ...
            <ul>
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.contractName') }}</label>
                <!-- 系统合约 -->
              ...
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.contractCreator') }}</label>
                <!-- 系统合约 -->
                <div class="money" v-if="detailInfo.type == '2'">
                  System Contract
                </div>
              ...
              <li>
                <label class="Gilroy-Medium">{{ $t('contract.tokenTracker') }}</label>
                <!-- tokens -->
